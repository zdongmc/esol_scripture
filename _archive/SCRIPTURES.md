...
> To add or edit a scripture, update this file and regenerate `translations.json`.
...
- Version listed is the English source version. Each language uses its own canonical version (see `LANGUAGES.md`).
